...
The _tree_ is made up of _nodes_; a single, outermost node forms the tree's root, and it contains all other nodes in the tree (or contains nodes that contain nodes, and so on).
...
The _value of a_ node depends on whether it has child nodes.
